...
![map4d](https://img.shields.io/badge/map4d-map-orange)
![platform](https://img.shields.io/badge/platform-reactnative-61dafb.svg)
![npm](https://img.shields.io/npm/v/react-native-map4d-map-dtqg)
...
Để sử dụng Map4dMap Rect Native, chạy lệnh sau để thêm `react-native-map4d-map-dtqg` vào file package.json

```shell
npm install react-native-map4d-map-dtqg --save
```

Import `react-native-map4d-map-dtqg` vào project files.
...
} from 'react-native-map4d-map-dtqg'
```
