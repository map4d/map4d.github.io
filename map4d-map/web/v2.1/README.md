...
<body>
  ...
  <script src="https://api-sdk-cdtqg.map4d.vn/sdk/map/js?version=SDK_VERSION&key=YOUR_API_KEY&callback=initMap"></script>
</body>
</html>
```
...
```JavaScript
<script defer src="https://api-sdk-cdtqg.map4d.vn/sdk/map/js?version=SDK_VERSION&key=YOUR_API_KEY&callback=CALLBACK_FUNCTION"></script>
```
