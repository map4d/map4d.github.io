...
[![npm](https://img.shields.io/npm/v/react-native-map4d-services-dtqg)](https://www.npmjs.com/package/react-native-map4d-services-dtqg)
...
```shell
npm i react-native-map4d-services-dtqg
```
